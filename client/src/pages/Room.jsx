  ...
  return <div className="min-h-screen bg-canvas">
    ...
    <main className="mx-auto max-w-5xl px-5 py-8">
      ...
      <div className="card overflow-hidden">
        ...
        <form onSubmit={send} className="flex gap-3 border-t border-slate-100 p-5"><input className="input-field" value={message} onChange={e=>setMessage(e.target.value)} placeholder={connectionStatus==="connected"?"Write a message...":"Waiting for connection..."} disabled={connectionStatus!=="connected"} /><button disabled={connectionStatus!=="connected"} className="primary-button px-4"><Send size={17}/></button></form>
      </div>
    </main>
  </div>
}