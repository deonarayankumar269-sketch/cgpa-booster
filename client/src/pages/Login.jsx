    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <section className="flex items-center justify-center px-5 py-10">
        <div className="w-full max-w-md">
          <div className="mb-8 flex items-center gap-3 lg:hidden"><div className="rounded-xl bg-indigo-600 p-2 text-white"><GraduationCap size={22}/></div><b className="text-xl text-navy">CGPA Booster</b></div>
          <div className="card p-8">
            ...
            <p className="mt-7 text-center text-sm text-slate-500">New to CGPA Booster? <Link to="/register" className="font-semibold text-indigo-600">Create an account</Link></p>
          </div>
        </div>
      </section>
    </div>
